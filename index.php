...
<div class="reminder_form">
  ...
  <table class="table">
  <thead>
    <tr style="background-color:#01b7fe;">
      <th scope="col">Sno.</th>
...
while($fetch_task=mysqli_fetch_array($result,MYSQLI_BOTH)){
 ?>
    ...
    <tr style="border:solid;">
      ...
      <?php echo "<td><a href='delete.php?sno=".$fetch_task['id']."'>Delete</a></td>";?>

        <?php echo "<td><a href='task_edit.php?id=".$fetch_task['id']."'>Edit</a></td>";?>
    </tr>
<?php ++$i;}} ?>
  </tbody>
</table>
